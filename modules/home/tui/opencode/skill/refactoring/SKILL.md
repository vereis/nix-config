...
> "Would you like me to implement these refactors? I'll use TodoWrite to track each change and implement them as atomic commits, running tests/linting after each one per our workflow."

If the user agrees:
1. Create a TodoWrite with each refactor as a separate item
