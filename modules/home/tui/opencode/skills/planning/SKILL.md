...
<subagent-context>
**IF YOU ARE A SUBAGENT**: You are already executing within a subagent context. DO NOT spawn additional subagents or use TodoWrite from this skill. Planning is a PRIMARY AGENT skill - if you're a subagent, you shouldn't be doing planning. Return to primary agent with analysis/recommendations instead.
</subagent-context>
